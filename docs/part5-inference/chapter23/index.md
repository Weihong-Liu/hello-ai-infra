---
title: "第23章 ONNX Runtime 与 MIGraphX 实战"
description: "Hello GPU 第23章 · ONNX 导出、ROCm 推理、MIGraphX 运行、工具层性能对比"
---

# 第23章 ONNX Runtime 与 MIGraphX 实战
...
- 与本章相关的代码、日志和实验底稿会放在 `code/part5-inference/chapter23/`。
