---
title: "第24章 视觉模型推理案例：YOLO"
description: "Hello GPU 第24章 · 图像预处理、NMS、单卡 batch 推理、pipeline profiling、性能报告"
---
...
- 与本章相关的代码、日志和实验底稿会放在 `code/part5-inference/chapter24/`。
