---
title: "第25章 LLM 单卡推理性能分析入门"
description: "Hello GPU 第25章 · Prefill、Decode、TTFT、TPOT、KV Cache、显存观测；多卡/多请求留给 hello-mlsys"
---
...
- 与本章相关的代码、日志和实验底稿会放在 `code/part5-inference/chapter25/`。
