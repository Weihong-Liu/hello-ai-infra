...
最后再强调一次：**本书所有实验数据基于 Radeon RX 9070 XT + ROCm 6.4.x（Linux）**。其他 AMD GPU 可以参考方法论，但性能数字和工具可用性需要自己实测验证。
...
- 实验结论基于 **Radeon RX 9070 XT + ROCm 6.4.x（Linux）**，其他设备的读者请以方法论为主、自行复测数据。
