---
title: "第28章 图优化原理基础"
description: "Hello GPU 第28章 · 算子融合、常量折叠、死代码消除、布局优化、Memory Planning 原理"
---
...
## 28.1 Operator Fusion

理解算子融合如何减少中间写回、kernel launch 和内存带宽压力。

## 28.2 Constant Folding
...
## 28.4 Common Subexpression Elimination

观察重复计算如何被复用。

## 28.5 Layout Transform

说明数据布局为什么影响后端 kernel 的访问效率。

## 28.6 Memory Planning
...
- 与本章相关的代码、日志和实验底稿会放在 `code/part6-compiler/chapter28/`。
